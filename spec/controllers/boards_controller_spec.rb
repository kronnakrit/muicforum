  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved board as @board" do
        ...
        post :create, {:board => { "title" => "invalid value" }}, valid_session
        assigns(:board).should be_a_new(Board)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested board" do
        ...
        Board.any_instance.should_receive(:update).with({ "title" => "MyText" })
        put :update, {:id => board.to_param, :board => { "title" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the board as @board" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Board.any_instance.stub(:save).and_return(false)
        put :update, {:id => board.to_param, :board => { "title" => "invalid value" }}, valid_session
        assigns(:board).should eq(board)
      end
